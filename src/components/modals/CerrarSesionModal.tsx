...
export default function CerrarSesionModal({ isOpen, onClose, onConfirm }: Props) {
    ...
    return (
        <Modal
            ...
            footer={
                <>
                    <button className="px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-full font-bold transition-colors" onClick={onClose}>Cancelar</button>
                    <button className="bg-red-600 hover:bg-red-700 text-white rounded-full px-4 py-2 font-bold shadow-lg shadow-red-100 transition-all active:scale-95" onClick={handleConfirm}>
                        Cerrar Inventario
                    </button>
                </>
            }
